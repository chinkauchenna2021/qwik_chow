...
//                               child:
//                                   Center(child: showEmptyState('No Messages Yet'.tr(), description: 'Send a new message and it will show up here'.tr())),
//                             );
//                           } else {
...
//                     height: 8,
//                     decoration: BoxDecoration(
//                         color: homeConversationModel.members.firstWhere((element) => element.userID == messageData.senderID).isActive
//                             ? Colors.green
//                             : Colors.grey,
