...
async function storeImageData() {
            var newPhoto = '';
            try {
                if (couponImageFile != "" && photo_coupon != couponImageFile) {
                    var couponOldImageUrlRef = await storage.refFromURL(couponImageFile);
                    /*await couponOldImageUrlRef.delete().then(() => {
