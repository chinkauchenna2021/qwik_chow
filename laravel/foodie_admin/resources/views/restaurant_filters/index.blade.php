        ...
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">{{trans('lang.restaurant_filter')}}</li>
                </ol>
            </div>
                            ...
                            <div class="table-responsive m-t-10">
                                ...
                                <table id="example24" class="display nowrap table table-hover table-striped table-bordered table table-striped" cellspacing="0" width="100%">
                                    ...
                                    <thead>
                                        ...
                                        <tr>
                                            <th>{{ trans('lang.restaurant_filter_name')}}</th>
                                            <th>{{trans('lang.restaurant_filter_options')}}</th>
...
function buildHTML(snapshots){
    ...
    alldata.forEach((listval) => {
        ...
        var val=listval;
            ...
            html=html+'<td class="action-btn"><a href="'+route1+'"><i class="fa fa-edit"></i></a><a id="'+val.id+'" name="restaurant-filter-delete" href="javascript:void(0)"><i class="fa fa-trash"></i></a></td>';
