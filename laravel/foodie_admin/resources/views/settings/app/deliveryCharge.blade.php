    ...
    <div class="row page-titles">
        ...
        <div class="card-body">
          ...
          <div class="form-group col-12 text-center">
            <button type="button" class="btn btn-primary save_admin_settings" ><i class="fa fa-save"></i> {{trans('lang.save')}}</button>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $(".save_admin_settings").click(function(){
          ...
          database.collection('settings').doc("DeliveryCharge").update({'vendor_can_modify':checkboxValue,'delivery_charges_per_km':delivery_charges_per_km,'minimum_delivery_charges':minimum_delivery_charges,'minimum_delivery_charges_within_km':minimum_delivery_charges_within_km}).then(function(result) {
