...
import 'package:flutter_application_1/ui/phoneAuth/PhoneNumberInputScreen.dart';
...
class _SignUpState extends State<SignUpScreen> {
  ...
  _signUpWithEmailAndPassword() async {
    ...
    dynamic result = await FireStoreUtils.firebaseSignUpWithEmailAndPassword(
        email!.trim(), password!.trim(), _image, firstName!, lastName!, mobile!, context, referralCode.toString());
    await hideProgress();
