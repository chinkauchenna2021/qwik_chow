...
import 'package:flutter_application_1/ui/dineInScreen/table_order_details_screen.dart';
      ...
      child: StreamBuilder<List<BookTableModel>>(
          ...
          builder: (context, snapshot) {
            ...
            if (!snapshot.hasData || (snapshot.data?.isEmpty ?? true)) {
              return Center(
                child: showEmptyState('No Previous Booking'.tr(), context, description: "Book Table".tr()),
              );
            } else {
